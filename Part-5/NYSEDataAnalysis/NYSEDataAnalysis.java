...
public class NYSEDataAnalysis {
    public static class NYSEDataWritable implements Writable {
        ...
        public String toString() {
            return "Max Stock Volume Date: " + maxStockVolumeDate +
                    ", Min Stock Volume Date: " + minStockVolumeDate +
                    ", Max Stock Price Adj Close: " + maxStockPriceAdjClose;
        }
    }
    ...
    public static class NYSEMapper extends Mapper<LongWritable, Text, Text, NYSEDataWritable> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            // Set the output key as the stock symbol (or any other relevant key)
    ...
    public static class NYSEReducer extends Reducer<Text, NYSEDataWritable, Text, NYSEDataWritable> {
        private NYSEDataWritable outputValue = new NYSEDataWritable();
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.addInputPath(job, new Path("/stocks"));
